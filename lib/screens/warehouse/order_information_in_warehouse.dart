...
class OrderInformationInWarehouse extends StatefulWidget{
  const OrderInformationInWarehouse({super.key});
  @override

  OrderInformationInWarehouseScreenState createState()=> OrderInformationInWarehouseScreenState();
  
}
// this is the class to another
class OrderInformationInWarehouseScreenState extends State<OrderInformationInWarehouse>{
   List<Order> orders = [];
  bool isLoading = true;
